    ...
    return (
        <div className="featArtCont">
            ...
            <div className="artistBioCont"> 
             ...
             <Popup trigger={<button className="btn"> Show More </button>} modal closeOnDocumentClick>
             {close => (
                <div className="bioOnClickCont">
                    <div className="modalTitle">{artistin.name}<span>'s Artist Bio </span>
                    <button 
                    onClick={() => {
                       close();
                    }}>X</button></div>
                    <div className="bioContBio"><span>{artistin.bio}</span></div>
